...
namespace BusinessLayer.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public AuthManager(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, ILogService logService, IConfiguration configuration)
        {
        ...
        public async Task<GeneralIdentityDto> SeedRolesAsync()
        {
        ...
        public async Task<GeneralIdentityDto> RegisterAsync(RegisterDto registerDto)
        {
        ...
        public async Task<GeneralIdentityDto> UpdateRoleAsync(ClaimsPrincipal User, UpdateRoleDto updateRoleDto)
        {
            ...
            if (User.IsInRole(StaticUserRoles.ADMIN))
            {
                ...
                else return new GeneralIdentityDto()
                {
                    IsSucceed = false,
                    StatusCode = 403,
                    Message = "You are not allowed to change role of this user"
